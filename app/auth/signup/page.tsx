...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Redirect to verification page or dashboard after successful signup
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#466cf4] to-[#3a5ce0] flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Join Shopella and start shopping with credit</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-start">
            ...
            <label htmlFor="terms" className="ml-2 block text-sm text-gray-700">
              I agree to the{" "}
              <Link href="/terms" className="text-[#466cf4] hover:text-[#3a5ce0]">
                Terms of Service
              </Link>{" "}
              and{" "}
              <Link href="/privacy" className="text-[#466cf4] hover:text-[#3a5ce0]">
                Privacy Policy
              </Link>
            </label>
          </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-600">
            ...
            <Link href="/auth/login" className="text-[#466cf4] hover:text-[#3a5ce0] font-medium">
              Sign in
            </Link>
          </p>
        </div>
