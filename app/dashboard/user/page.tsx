...
const recentOrders = [
  { id: 1, product: "iPhone 15 Pro", amount: 999, status: "Delivered", date: "2024-01-15" },
  { id: 2, product: "Samsung Galaxy S24", amount: 899, status: "Shipped", date: "2024-01-12" },
  { id: 3, product: "MacBook Air M3", amount: 1299, status: "Processing", date: "2024-01-10" },
]
    ...
    switch (activeTab) {
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-orange-600">{userData.pendingOrders}</p>
                  </div>
      ...
      case "loans":
        return (
          <div className="space-y-6">
            <div className="bg-white rounded-lg shadow-md p-6">
              <h3 className="text-lg font-semibold mb-4">Available Loan Providers</h3>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-lg shadow-md p-6">
              <div className="flex justify-between items-center mb-4">
                ...
                <Button onClick={() => setShowAddFunds(true)} className="bg-[#466cf4] hover:bg-[#3a5ce0]">
              ...
              <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
                <div className="bg-white rounded-lg p-6 w-full max-w-md">
                  ...
                  <div className="space-y-4">
                    ...
                    <Button onClick={handleAddFunds} className="w-full bg-[#466cf4] hover:bg-[#3a5ce0]">
                      Add Funds
                    </Button>
                  </div>
                </div>
        ...
        >
          <div className="p-4">
            <div className="flex items-center space-x-3 mb-6">
              <img src={userData.avatar || "/placeholder.svg"} alt="Profile" className="h-12 w-12 rounded-full" />
              <div>
              ...
              {sidebarItems.map((item) => (
                <button
                  ...
                  className={`w-full flex items-center space-x-3 p-3 rounded-lg text-left transition-colors ${
                    activeTab === item.id ? "bg-[#466cf4] text-white" : "hover:bg-gray-100 text-gray-700"
                  }`}
                >
