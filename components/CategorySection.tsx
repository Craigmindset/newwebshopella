...
const brands = [
  { id: 1, name: "Apple", logo: "/brands/apple logo.png" },
  { id: 2, name: "Apple Alt", logo: "/brands/apple-alt.png" },
  { id: 3, name: "Binatone", logo: "/brands/binatone.png" },
  { id: 4, name: "Dell", logo: "/brands/Dell logo.jpeg" },
  ...
  { id: 11, name: "Sony", logo: "/brands/Sony.png" },
...
export default function CategorySection() {
  ...
  const visibleBrands = Array.from({ length: visibleCount }, (_, i) => brands[(startIdx + i) % brands.length])

  return (
    <div className="bg-white py-16">
      <div className="max-w-7xl mx-auto px-4">
        <h2 className="text-3xl font-bold text-center text-gray-900 mb-8">Shop by Brands</h2>
        <div className="flex gap-6 justify-center items-center overflow-hidden">
          {visibleBrands.map((brand) => (
            <a key={brand.id} href="#" className="flex items-center justify-center cursor-pointer group">
